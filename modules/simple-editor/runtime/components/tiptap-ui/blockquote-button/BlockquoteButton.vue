...
interface BlockquoteButtonProps extends /* @vue-ignore */ Omit<ButtonProps, 'type' | 'disabled'>, UseBlockquoteConfig {
  showShortcut?: boolean
  text?: string
}

const { hideWhenUnavailable = false, onToggled, text, ...buttonProps } = defineProps<BlockquoteButtonProps>()
...
const { isVisible, canToggle, isActive, label, Icon, handleToggle } = useBlockquote({
  editor,
