export const tabsInfo = {
  ...
  good: { title: '精华板块 - CNode技术社区', name: '精华', total: 18 },
  share: { title: '分享板块 - CNode技术社区', name: '分享', total: 203 },
  ask: { title: '问答 - CNode技术社区', name: '问答', total: 323 },
  job: { title: '招聘 - CNode技术社区', name: '招聘', total: 65 },
